...
const MovieCard = ({ movie }) => {
  return (
    <div className="group capitalize relative cursor-pointer rounded-xl overflow-hidden border border-zinc-700 bg-zinc-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-teal-400">
      {/* Poster */}
      <div className="relative h-80 bg-linear-to-br from-teal-500 to-zinc-800 flex items-center justify-center overflow-hidden transition-all duration-500 group-hover:scale-105">
        {/* Big letter */}
        <p className="relative z-10 text-5xl font-bold text-slate-300 capitalize transition-all duration-500 group-hover:scale-105 group-hover:opacity-5 group-hover:blur-sm">
